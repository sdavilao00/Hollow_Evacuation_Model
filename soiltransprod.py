# -*- coding: utf-8 -*-
"""
Created on Fri Nov  1 11:03:49 2024
...
# #%%
# # Input GeoTIFF file and directories
...
# #%%
# # Conversion factors for unit handling
# ft2mUS = 1200 / 3937  # US survey foot to meter
# ft2mInt = 0.3048      # International foot to meter

# # Convert GeoTIFF to ASCII grid format
# def tiff_to_asc(in_path, out_path):
#     with rasterio.open(in_path) as src:
#         XYZunit = src.crs.linear_units   # Assumes units are the same in all directions
...
#     print(f"Initialized soil depth grid with shape {soil_depth_grid.shape} and depth {initial_soil_depth}m")
#     return soil_depth_grid

# # Calculate soil production
# def calculate_soil_production(soil_depth_grid, dt):
#     production_rate = (pr / ps) * (P0 * np.exp(-soil_depth_grid / h0)) * dt
#     print("Calculated soil production for the time step.")
#     return production_rate

# # Save the hillshade plot as PNG and save ASCII data
...
# #%%
# # Run the soil transport and soil production simulation
...
K = 0.005  # Diffusion coefficient
Sc = 1.25  # Critical slope gradient
dt = 100  # Time step duration (in years)
